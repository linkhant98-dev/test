...
import { ShieldCheck, Plus, Search, Lock, Unlock, Edit2, Trash2, Loader2, Save, CheckCircle2 } from "lucide-react"
...
export default function RolesPermissionsPage() {
  ...
  const handleSaveRole = () => {
    ...
    if (editingRole) {
      updateDocumentNonBlocking(doc(db, "system_roles", editingRole.id), formData, { email: user.email, uid: user.uid })
